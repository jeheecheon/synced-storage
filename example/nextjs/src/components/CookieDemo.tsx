...
export default function CookieDemo() {
  ...
  return (
    <div className="border border-amber-500/40 rounded-lg p-6 space-y-4">
      <div>
        <span className="text-xs text-amber-400 uppercase tracking-widest font-semibold">Cookie State</span>
        <p className="text-zinc-400 text-sm mt-1">Persists across sessions via HTTP cookie.</p>
      </div>
      ...
      <div className="flex gap-2">
        ...
        <button onClick={() => setCount((prev) => prev + 1)} className="px-3 py-1.5 rounded bg-amber-500 text-zinc-950 text-sm font-semibold hover:bg-amber-400">+1</button>
