...
export default function SessionStorageDemo() {
  ...
  return (
    <div className="border border-emerald-500/40 rounded-lg p-6 space-y-4">
      ...
      <p className="text-5xl font-bold text-emerald-300 tabular-nums">
        {count}
      </p>
      <div className="flex gap-2">
        ...
        <button
          onClick={() => setCount((prev) => prev + 1)}
          className="px-3 py-1.5 rounded bg-emerald-500 text-zinc-950 text-sm font-semibold hover:bg-emerald-400"
        >
          +1
        </button>
        <button
